 ...
 */Dygraph.prototype.xAxisExtremes = function(){var pad=this.getNumericOption('xRangePad') / this.plotter_.area.w;if(this.numRows() === 0){return [0 - pad,1 + pad];}var left=this.rawData_[0][0];var right=this.rawData_[Object.keys(this.rawData_).length - 1][0];if(pad){ // Must keep this in sync with dygraph-layout _evaluateLimits()
 ...
 */Dygraph.prototype.numRows = function(){if(!this.rawData_)return 0;return Object.keys(this.rawData_).length;}; /**
 ...
 *     were out of range.
 */Dygraph.prototype.getValue = function(row,col){if(row < 0 || row > Object.keys(this.rawData_).length)return null;if(col < 0 || col > this.rawData_[row].length)return null;return this.rawData_[row][col];}; /**
